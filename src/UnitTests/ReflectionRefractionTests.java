...
public class ReflectionRefractionTests 
{
	 ...
	 */
	@Test
	public void twoSpheres() // -x left, +x right, -y Up, +y down
	{
    ...
    @Test
	public void twoSpheresOnMirrors() // -x left, +x right, -y Up, +y down
	{
		Scene scene = new Scene("Test scene");
	 ...
	 */
	@Test
	public void trianglesTransparentSphere() // -x left, +x right, -y Up, +y down
	{
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
	 ...
	 */
	@Test
	public void OurTrianglesTransparentSphere() // -x left, +x right, -y Up, +y down
	{
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		...
		scene.addGeometries( //
				...
				new Triangle(Color.BLACK, new Material(0.5, 0.5, 60), //
						new Point3D(-150, 150, 115), new Point3D(-70, -70, 140), new Point3D(75, -75, 150)), //
				new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.6, 0), // )
						new Point3D(60, -30, 50), 30),
				new Sphere(new Color(java.awt.Color.CYAN), new Material(0.2, 0.2, 30), // moving down by moving in the positive direction of y
						new Point3D(0, -30, 50), 15));
