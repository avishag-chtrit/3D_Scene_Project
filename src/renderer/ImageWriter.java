...
public class ImageWriter 
{
	...
	/**
	 * copy constructor
	 * only after writing it we found out we were told not to...
	 */
	/*
	public ImageWriter(ImageWriter iw)
	{
		_imageName = iw._imageName;
		_imageWidth = iw._imageWidth;
		_imageHeight = iw._imageHeight;
		_nX = iw._nX;
		_nY = iw._nY;
		
		_image = new BufferedImage(iw._nX, iw._nY, BufferedImage.TYPE_INT_RGB);
	}
	*/
